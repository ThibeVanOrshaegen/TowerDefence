...
namespace Towerdefense
{
    ...
    bool Towerdefense::Game::isGKeyPressed = false;
    
    bool Towerdefense::Game::spriteVisibleP = false;
    bool Towerdefense::Game::spriteVisibleG = false;
    ...
    bool Towerdefense::Game::outOfRangenew = false;
    bool Towerdefense::Game::running = false;
    ...
    void Game::updateRotationGame() {
        ...
        updaterotation.updateShooterRotationLaserkogel(laserkogel, traag, 0);
        updaterotation.updateShooterRotationLaserkogel(laserkogeltwee, traag, 0);
        updaterotation.updateShooterRotationLaserkogel(laserkogeldrie, traag, 0);
        updaterotation.updateShooterRotationLaserkogel(laserkogelvier, traag, 0);
        updaterotation.updateShooterRotationLaserkogel(laserkogelvijf, traag, 0);
        updaterotation.updateShooterRotationLaserkogel(laserkogelzes, traag, 0);
    }
    ...
    void Game::run(sf::RenderWindow& window) {
        ...
        while (window.isOpen())
        {
            ...
            window.draw(*(textureManager.spriteGameopenmenu));
            window.draw(*(textureManager.spritepaperopenmenu));
            window.draw(*(textureManager.spritetowerdefensetextmenu));
            window.draw(*(textureManager.spriteplaybuttonmenu));
            window.draw(*(textureManager.spriteoptionbuttonmenu));

            if (spriteVisibleG)
            {
            window.draw(*(textureManager.spriteRolwapens));
            window.draw(*(textureManager.spritetowerdefensetextmenueen));
            window.draw(*(textureManager.spritetowerdefensetextmenutwee));
            window.draw(*(textureManager.spritetowerdefensetextmenudrie)); //game over maken 
            window.draw(*(textureManager.spritetowerdefensetextmenuvier));
            window.draw(*(textureManager.spritetowerdefensetextmenuvijf));
            ...
            if (spriteVisibleP)
            {
                    ...
                    if (spriteBuyblue)
                    {
                        ...
                        useWeapon(*canonplaatstwee, textureManager.spritecanonleveleen.getPosition(), 1180, 720, 0, 0);
                        useWeapon(*canonkogeltwee, shooterPositiontwee, 1180, 720, 0, 0);
                        ...
                        if (snel->spriteEnemy.getPosition().x < canonplaatstwee->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y < canonplaatstwee->spritecanonleveleen.getPosition().y)
                        {
                            ...
                            canonkogeltwee->fire(shooterPositiontwee, 1180, 720, 0, 0);
                        }
                        if (snel->spriteEnemy.getPosition().x < canonplaatstwee->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y == canonplaatstwee->spritecanonleveleen.getPosition().y)
                        {
                    ...
                    if (spriteBuyRed)
                    {
                        ...
                        useWeapon(*laserplaatstwee, textureManager.spritelaserleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, laserkogeltwee->spriteLaserKogeltwee);
                        useWeapon(*laserkogeltwee, shooterPositiontwee, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        if (traag->spriteEnemy.getPosition().x < laserplaatstwee->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y < laserplaatstwee->spritelaserleveleen.getPosition().y)
                        {
                            ...
                            laserkogeltwee->fire(shooterPositiontwee, 1180, 720, 0, 0);
                        }
                        if (traag->spriteEnemy.getPosition().x < laserplaatstwee->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y == laserplaatstwee->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                        ...
                        else if (traag->spriteEnemy.getPosition().x == laserplaatstwee->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y > laserplaatstwee->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(0.0f, 1.0f);  // move right
                            laserkogeltwee->update(direction.x, direction.y);
                            laserkogeltwee->fire(shooterPositiontwee, 1180, 720, 0, 0);
                    ...
                    if (spriteBuybluetwee) //stuur iets naar de terminal
                    {
                        ...
                        useWeapon(*canonplaatsdrie, textureManager.spritecanonleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, canonkogeldrie->spriteCanonKogeltwee);
                        useWeapon(*canonkogeldrie, shooterPositiondrie, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        ...
                        if (snel->spriteEnemy.getPosition().x < canonplaatsdrie->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y < canonplaatsdrie->spritecanonleveleen.getPosition().y)
                        {
                            ...
                            canonkogeldrie->fire(shooterPositiondrie, 1180, 720, 0, 0);
                        }
                        if (snel->spriteEnemy.getPosition().x < canonplaatsdrie->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y == canonplaatsdrie->spritecanonleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                    ...
                    if (spriteBuyRedtwee)
                    {
                        ...
                        useWeapon(*laserplaatsdrie, textureManager.spritelaserleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, laserkogeldrie->spriteLaserKogeltwee);
                        useWeapon(*laserkogeldrie, shooterPositiondrie, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        if (traag->spriteEnemy.getPosition().x < laserplaatsdrie->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y < laserplaatsdrie->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, -1.0f);  // move right
                            laserkogeldrie->update(direction.x, direction.y);
                            laserkogeldrie->fire(shooterPositiondrie, 1180, 720, 0, 0);
                        }
                        if (traag->spriteEnemy.getPosition().x < laserplaatsdrie->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y == laserplaatsdrie->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                        ...
                        else if (traag->spriteEnemy.getPosition().x == laserplaatsdrie->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y > laserplaatsdrie->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(0.0f, 1.0f);  // move right
                            laserkogeldrie->update(direction.x, direction.y);
                            laserkogeldrie->fire(shooterPositiondrie, 1180, 720, 0, 0);
                    ...
                    if (spriteBuybluedrie)
                    {
                        ...
                        useWeapon(*canonplaats, textureManager.spritecanonleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, canonkogel->spriteCanonKogeltwee);
                        useWeapon(*canonkogel, shooterPosition, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        ...
                        if (snel->spriteEnemy.getPosition().x < canonplaats->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y < canonplaats->spritecanonleveleen.getPosition().y)
                        {
                            ...
                            canonkogel->fire(shooterPosition, 1180, 720, 0, 0);
                        }
                        if (snel->spriteEnemy.getPosition().x < canonplaats->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y == canonplaats->spritecanonleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                    ...
                    if (spriteBuyReddrie)
                    {
                        ...
                        useWeapon(*laserplaats, textureManager.spritelaserleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, laserkogel->spriteLaserKogeltwee);
                        useWeapon(*laserkogel, shooterPosition, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        if (traag->spriteEnemy.getPosition().x < laserplaats->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y < laserplaats->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, -1.0f);  // move right
                            laserkogel->update(direction.x, direction.y);
                            laserkogel->fire(shooterPosition, 1180, 720, 0, 0);
                        }
                        if (traag->spriteEnemy.getPosition().x < laserplaats->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y == laserplaats->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                        ...
                        else if (traag->spriteEnemy.getPosition().x == laserplaats->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y > laserplaats->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(0.0f, 1.0f);  // move right
                            laserkogel->update(direction.x, direction.y);
                            laserkogel->fire(shooterPosition, 1180, 720, 0, 0);
                    ...
                    if (spriteBuybluevier)
                    {
                        ...
                        useWeapon(*canonplaatsvier, textureManager.spritecanonleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, canonkogelvier->spriteCanonKogeltwee);
                        useWeapon(*canonkogelvier, shooterPositionvier, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        ...
                        if (snel->spriteEnemy.getPosition().x < canonplaatsvier->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y < canonplaatsvier->spritecanonleveleen.getPosition().y)
                        {
                            ...
                            canonkogelvier->fire(shooterPositionvier, 1180, 720, 0, 0);
                        }
                        if (snel->spriteEnemy.getPosition().x < canonplaatsvier->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y == canonplaatsvier->spritecanonleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                    ...
                    if (spriteBuyRedvier)
                    {
                        ...
                        useWeapon(*laserplaatsvier, textureManager.spritelaserleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, laserkogelvier->spriteLaserKogeltwee);
                        useWeapon(*laserkogelvier, shooterPositionvier, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        if (traag->spriteEnemy.getPosition().x < laserplaatsvier->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y < laserplaatsvier->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, -1.0f);  // move right
                            laserkogelvier->update(direction.x, direction.y);
                            laserkogelvier->fire(shooterPositionvier, 1180, 720, 0, 0);
                        }
                        if (traag->spriteEnemy.getPosition().x < laserplaatsvier->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y == laserplaatsvier->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                        ...
                        else if (traag->spriteEnemy.getPosition().x == laserplaatsvier->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y > laserplaatsvier->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(0.0f, 1.0f);  // move right
                            laserkogelvier->update(direction.x, direction.y);
                            laserkogelvier->fire(shooterPositionvier, 1180, 720, 0, 0);
                    ...
                    if (spriteBuybluevijf)
                    {
                        ...
                        useWeapon(*canonplaatsvijf, textureManager.spritecanonleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, canonkogelvijf->spriteCanonKogeltwee);
                        useWeapon(*canonkogelvijf, shooterPositionvijf, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        ...
                        if (snel->spriteEnemy.getPosition().x < canonplaatsvijf->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y < canonplaatsvijf->spritecanonleveleen.getPosition().y)
                        {
                            ...
                            canonkogelvijf->fire(shooterPositionvijf, 1180, 720, 0, 0);
                        }
                        if (snel->spriteEnemy.getPosition().x < canonplaatsvijf->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y == canonplaatsvijf->spritecanonleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                    ...
                    if (spriteBuyRedvijf)
                    {
                        ...
                        useWeapon(*laserplaatsvijf, textureManager.spritelaserleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, laserkogelvijf->spriteLaserKogeltwee);
                        useWeapon(*laserkogelvijf, shooterPositionvijf, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        if (traag->spriteEnemy.getPosition().x < laserplaatsvijf->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y < laserplaatsvijf->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, -1.0f);  // move right
                            laserkogelvijf->update(direction.x, direction.y);
                            laserkogelvijf->fire(shooterPositionvijf, 1180, 720, 0, 0);
                        }
                        if (traag->spriteEnemy.getPosition().x < laserplaatsvijf->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y == laserplaatsvijf->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                        ...
                        else if (traag->spriteEnemy.getPosition().x == laserplaatsvijf->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y > laserplaatsvijf->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(0.0f, 1.0f);  // move right
                            laserkogelvijf->update(direction.x, direction.y);
                            laserkogelvijf->fire(shooterPositionvijf, 1180, 720, 0, 0);
                    ...
                    if (spriteBuybluezes)
                    {
                        ...
                        useWeapon(*canonplaatszes, textureManager.spritecanonleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, canonkogelzes->spriteCanonKogeltwee);
                        useWeapon(*canonkogelzes, shooterPositionzes, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        if (snel->spriteEnemy.getPosition().x < canonplaatszes->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y < canonplaatszes->spritecanonleveleen.getPosition().y)
                        {
                            ...
                            canonkogelzes->fire(shooterPositionzes, 1180, 720, 0, 0);
                        }
                        if (snel->spriteEnemy.getPosition().x < canonplaatszes->spritecanonleveleen.getPosition().x && snel->spriteEnemy.getPosition().y == canonplaatszes->spritecanonleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                    ...
                    if (spriteBuyRedzes)
                    {
                        ...
                        useWeapon(*laserplaatszes, textureManager.spritelaserleveleen.getPosition(), 1180, 720, 0, 0);
                        drawSpriteIfVisibleshoot::drawSpriteVisibleshoot(window, laserkogelzes->spriteLaserKogeltwee);
                        useWeapon(*laserkogelzes, shooterPositionzes, 1180, 720, 0, 0);
                        //canonkogel->update(snel->spriteEnemy.getPosition(), shooterPosition);
                        if (traag->spriteEnemy.getPosition().x < laserplaatszes->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y < laserplaatszes->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, -1.0f);  // move right
                            laserkogelzes->update(direction.x, direction.y);
                            laserkogelzes->fire(shooterPositionzes, 1180, 720, 0, 0);
                        }
                        if (traag->spriteEnemy.getPosition().x < laserplaatszes->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y == laserplaatszes->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(-1.0f, 0.0f);  // move right
                        ...
                        else if (traag->spriteEnemy.getPosition().x == laserplaatszes->spritelaserleveleen.getPosition().x && traag->spriteEnemy.getPosition().y > laserplaatszes->spritelaserleveleen.getPosition().y)
                        {
                            sf::Vector2f direction(0.0f, 1.0f);  // move right
                            laserkogelzes->update(direction.x, direction.y);
                            laserkogelzes->fire(shooterPositionzes, 1180, 720, 0, 0);
