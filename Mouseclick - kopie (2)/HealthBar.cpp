...
namespace Towerdefense
{
    ...
    HealthBar::HealthBar(sf::Vector2f enemyPosition, sf::Vector2f size, int maxHealth) // primary constructor, Takes parameters enemyPosition, size, and maxHealth, a parameterized constructor.
